                ...
                <div className='w-full h-[15%] p-4 flex items-center gap-6 justify-between bg-gradient-to-r from-slate-950 to-violet-950 rounded-full px-8'>
                    ...
                    <div className="flex items-center gap-4 flex-shrink-0">
                        <div className='w-[60px] h-[60px] rounded-full overflow-hidden'>
                            <Image src={currentTrack?.image ?? DefaultImage} alt={currentTrack?.name} width={500} height={500} className="w-full h-full spin duration-1000" />
                        </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {isPlaying ? (
                            ...
                            <button onClick={() => handlePlay(currentTrack)}><PiPlayFill className="text-3xl text-white" /></button>
                        )}
